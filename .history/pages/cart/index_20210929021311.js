...
const stripePromise = loadStripe(process.env.NEXT_APP_PUB_KEY);
          ...
          <section className={styles.cart_content}>
              <div className={styles.interface}>
                  ...
                  <div className={styles.button_box}>
                      ...
                      {cartItems.length > 0 && <button role="link" onClick={handleClick} disabled={loading} className={styles.confirmBtn}>Comfirm</button>}
                  </div>
              </div>
          </section>
        </>
